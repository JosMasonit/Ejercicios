...
import com.crud.db1.infraestructure.exceptions.NotFoundException;
...
public class PersonaService implements IPersona {
    ...
    public PersonaOutputDTO actualizar(Integer id, PersonaInputDTO personaIDTO) {
        try{
    ...
    public PersonaOutputDTO addPersona(@Valid PersonaInputDTO personaIDTO) {
        try{
