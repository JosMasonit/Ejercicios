...
public class ControladorPersona1 {
    ...
    @GetMapping("/get")
    public Page<PersonaEntity> getData(@RequestParam(required=false, value="usuario") String usuario,
                                       ...
                                       @RequestParam(value="page", required=true) int page)
    {
        ...
        if (size==null)
            size=10;
        return (Page<PersonaEntity>) personaRepo.getData(data, PageRequest.of(page, size));
    }
                                            ...
                                            @RequestParam(value="page", required=true) int page)
    {
        ...
        return query.setMaxResults(size).setFirstResult(page * size).getResultList();
    }
